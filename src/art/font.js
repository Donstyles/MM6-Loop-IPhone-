...
const NORMAL = {
  ...
  '_': ['', '', '', '', '', '', '', '', '######'],
  '`': ['##', '.##'],
  // Lowercase is set on a 5-wide round so the colour of the text matches a real
  // book face; caps at 6-7 wide then read correctly larger, and words stop
  // looking loosely spaced.
  'a': ['', '', '', '.###', '....#', '.####', '#...#', '.####'],
  'b': ['##', '.#', '.#', '.###', '.#..#', '.#..#', '.#..#', '.###'],
  'c': ['', '', '', '.###', '#...#', '#', '#...#', '.###'],
  'd': ['...##', '....#', '....#', '.####', '#...#', '#...#', '#...#', '.####'],
