...
export const FLORA_DEFS = {
  ...
  pine: { h: 1050, aspect: 0.62 },
  pine_snow: { h: 1050, aspect: 0.62 },
  birch: { h: 820, aspect: 0.72 },
  willow: { h: 760, aspect: 1.15 },
  palm: { h: 780, aspect: 0.95 },
  dead_tree: { h: 700, aspect: 0.95 },
  cactus: { h: 340, aspect: 0.7 },
  bush: { h: 190, aspect: 1.05 },
  bush_berry: { h: 190, aspect: 1.05 },
  fern: { h: 130, aspect: 1.5 },
  reeds: { h: 200, aspect: 0.9 },
  mushroom_cluster: { h: 90, aspect: 1.3 },
  mushroom_giant: { h: 280, aspect: 1.15 },
  rock_small: { h: 90, aspect: 1.4 },
  rock_large: { h: 200, aspect: 1.35 },
  boulder: { h: 260, aspect: 1.25 },
  stump: { h: 110, aspect: 1.35 },
  log: { h: 90, aspect: 2.6 },
  flowers_white: { h: 90, aspect: 1.3 },
  flowers_red: { h: 90, aspect: 1.3 },
  grass_tuft: { h: 80, aspect: 1.3 },
  vine: { h: 320, aspect: 0.55 },
  sapling: { h: 260, aspect: 0.8 },
};
