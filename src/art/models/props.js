...
export const PROP_DEFS = {
  chest: { h: 90, aspect: 1.35 },
  chest_open: { h: 90, aspect: 1.35 },
  barrel: { h: 130, aspect: 0.95 },
  crate: { h: 110, aspect: 1.15 },
  sack: { h: 90, aspect: 1.05 },
  campfire: { h: 90, aspect: 1.5 },
  well: { h: 170, aspect: 0.95 },
  signpost: { h: 190, aspect: 0.95 },
  lamppost: { h: 260, aspect: 0.45 },
  torch_wall: { h: 130, aspect: 0.65 },
  altar: { h: 130, aspect: 1.25 },
  statue: { h: 230, aspect: 0.60 },
  gravestone: { h: 120, aspect: 0.95 },
  fountain: { h: 150, aspect: 1.55 },
  cart: { h: 110, aspect: 1.7 },
  haystack: { h: 170, aspect: 1.1 },
  anvil: { h: 90, aspect: 1.35 },
  ...
  bones: { h: 60, aspect: 1.9 },
  banner_pole: { h: 210, aspect: 0.65 },
  market_stall: { h: 150, aspect: 1.6 },
  item_sword: { h: 60, aspect: 1.0, item: 1 },
  item_bow: { h: 60, aspect: 1.0, item: 1 },
  item_shield: { h: 55, aspect: 1.0, item: 1 },
  item_helm: { h: 45, aspect: 1.15, item: 1 },
  item_armor: { h: 55, aspect: 1.1, item: 1 },
  item_potion: { h: 45, aspect: 1.0, item: 1 },
  item_scroll: { h: 40, aspect: 1.5, item: 1 },
  item_gold: { h: 35, aspect: 1.6, item: 1 },
  item_gem: { h: 40, aspect: 1.1, item: 1 },
  item_ring: { h: 35, aspect: 1.1, item: 1 },
  item_wand: { h: 55, aspect: 0.9, item: 1 },
  item_book: { h: 40, aspect: 1.5, item: 1 },
};
